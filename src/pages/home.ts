...
export async function renderHome(root: HTMLElement): Promise<void> {
  ...
  let name = 'jogador';
  if (auth) {
    try { name = (await api.get<Perfil>('/api/usuarios/perfil/')).username; } catch { /* handled by request */ }
  }
  root.innerHTML = shell(`
    <section class="hero home-hero section-wrap">
      <div class="hero-copy">
        ...
        <p class="hero-text">Organize sua biblioteca, acompanhe cada hora jogada e transforme progresso em conquistas.</p>
